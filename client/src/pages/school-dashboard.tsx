...
import { SchoolPurchaseOverlay } from "../components/SchoolPurchaseOverlay";
                  ...
                  <div className="hamburger-dropdown fixed top-16 right-4 w-48 bg-white rounded-lg shadow-xl border border-gray-200 z-[99999]">
                    <div className="py-1">
                      ...
                      <button
                        ...
                        onClick={() => {
                          setShowHamburgerMenu(false);
                          setLocation("/revenue-sharing-setup");
                        }}
                        data-testid="menu-revenue-sharing"
                      >
            ...
            {[
              ...
              <button
                ...
                className={`relative px-3 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm font-medium border-b-2 flex items-center space-x-1 sm:space-x-2 whitespace-nowrap transition-colors min-w-fit ${
                  activeTab === tab.id
                    ? "border-blue-500 text-blue-600 bg-blue-50 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-400"
                    : "border-transparent text-gray-600 hover:text-gray-900 hover:border-gray-300 dark:text-gray-300 dark:hover:text-gray-100 dark:hover:border-gray-600"
                }`}
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
                      <button
                        ...
                        className={`p-1.5 rounded ${yearViewMode === 'grid' ? 'bg-white dark:bg-gray-700 shadow-sm text-blue-600 dark:text-blue-400' : 'text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100'}`}
                        title="Grid View"
                      >
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded ${yearViewMode === 'list' ? 'bg-white dark:bg-gray-700 shadow-sm text-blue-600 dark:text-blue-400' : 'text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100'}`}
                        title="List View"
                      >
                        ...
                        <div className="flex-shrink-0">
                          {year.purchased ? (
                            ...
                            >
                              ...
                              Purchase {formatPrice(convertPrice(year.price))}
                            </Button>
                          )}
                        </div>
                      </div>
