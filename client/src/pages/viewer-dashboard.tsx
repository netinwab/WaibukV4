...
import { Eye, LogOut, Images, BookOpen, UserCheck, GraduationCap, User, Home, Award, Plus, CreditCard, Trash2, Bell, X, Library, Folder, FolderOpen, Users, Search, Mail, Phone, ChevronLeft, ChevronRight, ZoomIn, ZoomOut, RotateCcw, Play, Calendar, Video, Menu, Settings, ShoppingCart } from "lucide-react";
        ...
        <Card className="shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-2xl font-bold text-blue-600">{formatPrice(convertPrice(purchasedYearbooks.length * 4.99))}</div>
