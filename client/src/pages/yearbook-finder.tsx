...
import { Eye, LogOut, BookOpen, Calendar, GraduationCap, Search, MapPin, Building, ShoppingCart, Grid3X3, List, Menu, Settings } from "lucide-react";
            ...
            <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-full max-w-md p-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Yearbook Price: <span className="font-semibold text-blue-600">${selectedYearForCart.price.toFixed(2)}</span>
                </p>
