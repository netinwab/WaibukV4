...
import { ArrowLeft, Download, ZoomIn, ZoomOut, Maximize2, Share2, BookOpen, FileText, Calendar, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function DynamicYearbookViewer() {
  ...
  const handleBack = () => {
    // Go back to yearbook finder with the current school parameter
    if (schoolId) {
      setLocation(`/yearbook-finder?school=${schoolId}`);
    } else {
              ...
              >
                ...
                {contentPages[currentPage] && (
                  <div className="bg-white shadow-lg border border-gray-300 relative"
                    ...
                    <div className="h-full relative">
                      <img
                        src={contentPages[currentPage].imageUrl}
                ...
                {contentPages[currentPage + 1] && (
                  <div className="bg-white shadow-lg border border-gray-300 relative"
                    ...
                    <div className="h-full relative">
                      <img
                        src={contentPages[currentPage + 1].imageUrl}
        ...
        <div className="min-h-screen bg-gray-50">
          ...
          <header className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 shadow-sm border-b border-gray-200 relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-0 left-0 w-full h-full">
                <div className="absolute top-0 left-1/4 w-64 h-64 bg-gradient-to-br from-blue-400 to-purple-600 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
                <div className="absolute top-0 right-1/4 w-64 h-64 bg-gradient-to-br from-yellow-400 to-pink-600 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
                <div className="absolute bottom-0 left-1/3 w-64 h-64 bg-gradient-to-br from-green-400 to-blue-600 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
              </div>
            </div>
              ...
              <div className="flex justify-between items-center h-16">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h1 className="text-lg font-semibold text-white">{yearbook?.title || `${year} Yearbook`}</h1>
                      <p className="text-sm text-white/80">{school?.name || "School"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  {hasContent && isPreviewMode && (
                    <>
                      <Button onClick={handleDownload} variant="outline" size="sm" className="text-white border-white/30 hover:bg-white/20">
                        <Download className="h-4 w-4 mr-2" />
                        Download
                      </Button>
                      <Button onClick={handleShare} variant="outline" size="sm" className="text-white border-white/30 hover:bg-white/20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                          ...
                          {frontCover && (
                            ...
                            >
                              <div className="flex justify-between">
                                ...
                                <span className="text-xs text-gray-400 ml-2">Cover</span>
                              </div>
                            </button>
                          )}
                          ...
                          {backCover && (
                            ...
                            >
                              <div className="flex justify-between">
                                ...
                                <span className="text-xs text-gray-400 ml-2">Back</span>
                              </div>
                            </button>
                          )}
                        </div>
              ...
              <div className={hasContent ? "lg:col-span-3" : "lg:col-span-4"}>
                <Card>
                  <CardContent className="p-4">
                    {renderPageView()}
                  </CardContent>
