...
import { ArrowLeft, Download, ZoomIn, ZoomOut, Maximize2, Share2, BookOpen, FileText, Calendar, ChevronLeft, ChevronRight, Menu, Settings, ShoppingCart, LogOut } from 'lucide-react';
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
              <div className="flex justify-between items-center h-12 sm:h-16">
                ...
                <div className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  {user && (
                    <span className="text-xs sm:text-sm font-medium text-white/90 hidden xs:block">
                  ...
                  {user && (
                    <div className="relative">
                      ...
                      {showHamburgerMenu && (
                        <div className="hamburger-dropdown fixed top-16 right-4 w-48 bg-white rounded-lg shadow-xl border border-gray-200 z-[99999]">
                          <div className="py-1">
                            <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 sm:gap-6">
              ...
              {hasContent && (
                <div className="lg:col-span-1 order-2 lg:order-1">
                  <Card className="sticky top-3 lg:top-6">
                    <CardContent className="p-3 sm:p-4">
                      ...
                      <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                        <div className="flex items-center space-x-1 sm:space-x-2">
                          ...
                          <span className="text-xs sm:text-sm font-medium flex-1 text-center">{zoomLevel}%</span>
                          <Button
                            onClick={handleZoomIn}
                            variant="outline"
                            size="sm"
