  ...
  const uploadMemoryMutation = useMutation({
    ...
    onMutate: async (data) => {
      ...
      const optimisticMemory = {
        ...
        videoUrl: data.file.type.startsWith('video') ? previewUrl : null,
      ...
      toast({
        ...
        description: "Your photo/video is being added to the yearbook!",
      });
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">
                  <span>Photos & Memories Management</span>
                  {school?.name && (
                    <span className="ml-2">
